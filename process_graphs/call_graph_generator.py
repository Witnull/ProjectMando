...
def compress_full_smart_contracts(smart_contracts, output, vulnerabilities=None):
    ...
    print('Dumped CG succesfully:', output)
...
def print_info():
    ...
    '''
    print("\n\n ###################### INFO ##################### \n\n")
    print(f"Usage: python call_graph_generator.py")
    print(f"{Fore.CYAN} This script generates call graphs (CG) for Solidity smart contracts.{Style.RESET_ALL}")
    print("It processes contracts in the specified directories for different bug types,")
    print("generates compressed call graphs, and saves them as .gpickle files.")
    print("The script uses vulnerability data from JSON files for annotation.")
    ...
    o = input(f"{Back.BLUE}Press 1 OR 2 to start generating call graphs...{Style.RESET_ALL}")
    if o not in ['1','2']:
...
if __name__ == '__main__':
    ...
    if option == '1':
        ...
        print(f"{Back.CYAN}Starting call graph generation...{Style.RESET_ALL}")
        ...
        for bug, counter in bug_type.items():
            ...
            output_CG_path = f'{ROOT}/{specific_name}{bug}/curated/cg_compressed_graphs.gpickle'
            print(f"{Back.CYAN}OUTPUT: {output_CG_path}{Style.RESET_ALL}")
            #############################
            ...
            compress_full_smart_contracts(smart_contracts, output_CG_path, vulnerabilities=data_vulnerabilities)
    elif option =='2':
        output_CG_path = f'./newMethods/sampleDataset/cg_compressed_graphs.gpickle'
        ...
        compress_full_smart_contracts(smart_contracts, output_CG_path, vulnerabilities=None)
    print(f"{Back.GREEN}Call graph generation completed!{Style.RESET_ALL}")
