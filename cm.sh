# buggy_type = ['access_control', 'arithmetic', 'denial_of_service', 'front_running', 'reentrancy', 'time_manipulation','unchecked_low_level_calls']
python node_classifier.py \
    -ld ./logs/node_classification/cfg/node2vec/access_control \
    --output_models ./models/node_classification/cfg/node2vec/access_control \
    --dataset ./ge-sc-data/node_classification/cfg/access_control/buggy_curated \
    --compressed_graph ./ge-sc-data/node_classification/cfg/access_control/buggy_curated/compressed_graphs.gpickle \
    --node_feature nodetype \
    --testset ./ge-sc-data/node_classification/cfg/curated/access_control \
    --seed 1 \
    --test 
    #--checkpoint ./models/node_classification/cfg/nodetype/arithmetic/han_fold_0.pth

# # Han
python node_classifier.py \
    -ld ./logs/node_classification/cfg/line_han/reentrancy \
    --output_models ./models/node_classification/cfg/line_han/reentrancy \
    --dataset ./experiments/ge-sc-data/source_code/reentrancy/buggy_curated \
    --compressed_graph ./experiments/ge-sc-data/source_code/reentrancy/buggy_curated/compressed_graphs.gpickle \
    --testset ./experiments/ge-sc-data/source_code/curated/reentrancy \
    --seed 1  --node_feature line \
    --feature_compressed_graph ./experiments/ge-sc-data/source_code/gesc_matrices_node_embeddingmatrix_line_dim128_of_core_graph_of_reentrancy_compressed_graphs.pkl \
    --cfg_feature_extractor ./data/smartbugs_wild/embeddings_buggy_currated_mixed/cfg_mixed/gesc_matrices_node_embedding/matrix_line_dim128_of_core_graph_of_reentrancy_compressed_graphs.pkl \
    --feature_extractor ./models/node_classification/cfg/line/reentrancy/han_fold_0.pth
...
python node_classifier.py \
    -ld ./logs/node_classification/cfg/nodetype/unchecked_low_level_calls \
    --output_models ./models/node_classification/cfg/nodetype/unchecked_low_level_calls \
    --dataset ./ge-sc-data/node_classification/cfg/unchecked_low_level_calls/buggy_curated \
    --compressed_graph ./ge-sc-data/node_classification/cfg/unchecked_low_level_calls/buggy_curated/compressed_graphs.gpickle \
    --node_feature nodetype --seed 1 --testset ./ge-sc-data/node_classification/cfg/curated/unchecked_low_level_calls \
    --feature_extractor ./ge-sc-data/node_classification/cfg/graph_embedding/undirected/gesc_matrices_node_embedding/matrix_nodetype_dim128_of_core_graph_of_unchecked_low_level_calls_compressed_graphs.pkl \
